...
// node_modules/@clerk/shared/dist/runtime/versionSelector-OOGehgnN.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.123.0") => {
  if (clerkJSVersion) return clerkJSVersion;
  const prereleaseTag = getPrereleaseTag(packageVersion);
  if (prereleaseTag) {
    if (prereleaseTag === "snapshot") return "5.123.0";
...
// node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-Pq1FuxjU.mjs
